...
$routes->get('/pendaftaran_haji_khusus/jamaah/preview_bukti_pendaftaran/(:any)', 'pendaftaran_haji_khusus\Jamaah::preview_bukti_pendaftaran/$1');
$routes->get('/pendaftaran_haji_khusus/jamaah/download_bukti_pendaftaran/(:any)', 'pendaftaran_haji_khusus\Jamaah::download_bukti_pendaftaran/$1');
...
$routes->get('/pendaftaran_umrah/jamaah/preview_bukti_pendaftaran/(:any)', 'pendaftaran_haji_khusus\Jamaah::preview_bukti_pendaftaran/$1');
$routes->get('/pendaftaran_umrah/jamaah/download_bukti_pendaftaran/(:any)', 'pendaftaran_haji_khusus\Jamaah::download_bukti_pendaftaran/$1');
