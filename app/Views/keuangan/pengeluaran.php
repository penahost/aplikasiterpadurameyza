                                    ...
                                    ?>
                                      <tr>
                                          ...
                                          <td>
                                            ...
                                            <a style="width:15px;" class="btn btn-danger" href="<?php echo base_url();?>/keuangan/pengeluaran/hapus/<?=$row->pengeluaran_id;?>/<?=$row->id_transaksi;?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ?');"><i class="fa fa-times"></i></a>
                                          </td>
