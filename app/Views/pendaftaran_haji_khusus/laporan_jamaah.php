              ...
              <div class="row">
                  <!-- <div class="col-md-6">
                          <div class="ibox">
                              ...
                              <div class="ibox-body">
                                  <a href="<?php echo base_url();?>/pendaftaran_haji_khusus/laporan/download_report_manifest/"  class="btn btn-success">Report Manifest</a>
                              </div>
                          </div>
                    </div> -->
                  <div class="col-xl-12">
                      <div class="ibox">
                          <div class="ibox-head">
                              <div class="ibox-title">
                                <a href="<?php echo base_url();?>/pendaftaran_haji_khusus/laporan/download_report_manifest/" class="btn btn-success"><i class="fa ti-import"></i> Report Manifest</a>
                              </div>
                          </div>
                          <div class="ibox-body">
