                                  ...
                                  <tbody>
                                    ...
                                    ?>
                                      <tr>
                                          ...
                                          <td>
                                            <a href="<?php echo base_url();?>/pendaftaran_umrah/jamaah/index/<?=$row->paket_id;?>">Lihat Jamaah</a>
                                          </td>
                                      </tr>
                                      <?php
                                      $no++;
                                  ...
                                  <tbody>
                                    ...
                                    ?>
                                      <tr>
                                          ...
                                          <td>
                                            <a href="<?php echo base_url();?>/pendaftaran_umrah/jamaah/edit/<?=$row->jamaah_id;?>">Edit</a>
                                            ||
                                            <a href="<?php echo base_url();?>/pendaftaran_umrah/jamaah/hapus/<?=$row->jamaah_id;?>/<?=$paket_id;?>">Hapus</a>
                                            ||
